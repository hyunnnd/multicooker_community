...
이번 수정본에서는 커뮤니티 작성자/수정/삭제/좋아요/알림을 로그인 계정 기준으로 분리했습니다.
...
```text
AUTH_API_BASE_URL=https://api.graphenesq.co.kr
...
```cmd
flutter run --dart-define=AUTH_API_BASE_URL=https://api.graphenesq.co.kr --dart-define=API_BASE_URL=http://192.1.0.28:8001
```
